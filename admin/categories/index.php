...
require_once $_SERVER['DOCUMENT_ROOT'] . '/php/session13/includes/access.inc.php';
...
if (isset($_GET['addform']))
{
  ...
  //include $_SERVER['DOCUMENT_ROOT'] . '/php/session13/includes/db.inc.php';
  include_once $_SERVER['DOCUMENT_ROOT'] . '/php/Session13/includes/db.inc.php'
